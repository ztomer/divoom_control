...
from divoom_lib.transport import Transport, COMMAND_TRANSPORT_MAP


from divoom_lib import models
from divoom_legacy.connection import DivoomConnection
from divoom_lib.models.capabilities import capabilities_for
from divoom_legacy.display.light import Light
from divoom_legacy.display.animation import Animation
from divoom_legacy.display.drawing import Drawing
from divoom_legacy.display.text import Text
...
from divoom_legacy.media.music import Music
from divoom_legacy.media.radio import Radio
from divoom_legacy.scheduling.alarm import Alarm
from divoom_legacy.scheduling.sleep import Sleep
from divoom_legacy.scheduling.timeplan import Timeplan
from divoom_legacy.tools.scoreboard import Scoreboard
from divoom_legacy.tools.timer import Timer
from divoom_legacy.tools.countdown import Countdown
from divoom_legacy.tools.noise import Noise
from divoom_legacy.tools.notification import Notification
from divoom_legacy.tools.hot_update import HotUpdate
from divoom_legacy.tools.aid_sleep import AidSleep
from divoom_legacy.display import Display
from divoom_legacy.display.design import Design
from divoom_legacy.system import System
from divoom_legacy.system.sound import SoundControl
from divoom_legacy.system.control import Control
from divoom_legacy.system.weather import Weather
from divoom_legacy.tool import Tool
from divoom_legacy.game import Game
...
class Divoom:
    ...
    def __init__(self, config: Optional[models.DivoomConfig] = None, mac: Optional[str] = None, logger: Optional[object] = None, **kwargs) -> None:
        ...
        self._lan = None
        if lan_ip:
            from divoom_legacy.lan_transport import LanTransport
    ...
    def capabilities(self):
        ...
        if self._advertisement_data is not None:
            from divoom_lib.models.capabilities import capabilities_from_manufacturer_data
