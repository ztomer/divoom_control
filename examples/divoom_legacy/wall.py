...
class DivoomWall:
    ...
    async def connect(self) -> dict:
        ...
        from divoom_legacy.ble_connection import connect_devices, BleConnectionError, WALL_CONNECT_CONCURRENCY
    ...
    async def _push_slot(self, divoom, path: str, time: int | None) -> bool:
        ...
        if not alive:
            from divoom_legacy.ble_connection import ensure_connected, BleConnectionError
