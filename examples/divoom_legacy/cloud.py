...
class CloudClient:
    ...
    #
    # Applying a selected ClockId to a device: ``divoom_legacy.display
    ...
    # cloud call at all — see ``divoom_legacy.tools.aid_sleep.AidSleep.play``
    ...
    # ``divoom_legacy.lan_transport.LanTransport.send_playlist`` (confirmed live
    ...
    # divoom_legacy.lan_transport.LanTransport.play_album
