...
from divoom_legacy.lan_transport_photo import LanPhotoMixin
from divoom_legacy.lan_transport_extras import LanExtrasMixin
...
class LanTransport(LanPhotoMixin, LanExtrasMixin):
    ...
    async def send_playlist(self, play_id: int) -> dict:
        ...
        ``divoom_legacy.cloud.CloudClient.get_my_playlists`` /
