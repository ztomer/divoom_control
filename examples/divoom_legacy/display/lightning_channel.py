...
from divoom_lib.utils.converters import number2HexString, color2HexString, boolean2HexString
...
class LightningChannel:
    ...
    async def show(self):
        """
        Activates and displays the Lightning Channel with its current settings.
        """
