...
# The glyph blobs stay in divoom_lib/fonts/: the daemon include_bytes!() them
# (divoomd/src/live_jobs/font.rs), so they are product data, not legacy code.
_BLOBS = Path(__import__("divoom_lib").__file__).parent / "fonts"
_ASSET = _BLOBS / "divoom_fond16_default_ascii.bin"
...
_ASSET_HALF = _BLOBS / "divoom_fond16_default_half.bin"
