...
from divoom_legacy.fonts import BitmapFont, get_default_font

REPO_ROOT = Path(__file__).resolve().parents[2]
MEDIA_SOURCE = REPO_ROOT / "examples" / "divoom_legacy" / "utils" / "media_source.py"
...
def test_small_font_is_half_height_of_default() -> None:
    ...
    from divoom_legacy.fonts import get_default_font, get_small_font
