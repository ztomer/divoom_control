...
from divoom_legacy.utils.divoom_image_encode import encode_animation_frame as py_encode_animation_frame, encode_static_image as py_encode_static_image, _py_encode_animation
