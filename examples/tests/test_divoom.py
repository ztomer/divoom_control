...
def mock_divoom_instance():
    ...
    with patch('divoom_legacy.protocol.DivoomProtocol.send_command_and_wait_for_response', new_callable=AsyncMock) as mock_send_command_and_wait, \
         patch('divoom_legacy.protocol.DivoomProtocol.send_command', new_callable=AsyncMock) as mock_send_command:
...
async def test_send_diagnostic_payload_spp_success(mock_divoom_instance):
    ...
    with patch('divoom_legacy.divoom.cache', mock_cache_util):
