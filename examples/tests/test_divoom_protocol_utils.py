...
from divoom_legacy.divoom import Divoom as DivoomBase
from divoom_lib import models as constants
from divoom_legacy.utils import cache as cache_util
...
class TestDivoomProtocolUtils(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        patcher_load = patch('divoom_legacy.utils.cache.load_device_cache', self.mock_load_device_cache)
        patcher_save = patch('divoom_legacy.utils.cache.save_device_cache', self.mock_save_device_cache)
