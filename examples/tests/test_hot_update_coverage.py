...
from support.hot_update_common import (  # noqa: F401
    _FakeResp,
    _clear_hot_cache,
    _file,
)
from divoom_legacy.tools.hot_update import HotFile, HotUpdate, clear_hot_manifest_cache, download_hot_file, fetch_hot_manifest
