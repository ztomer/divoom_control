...
from divoom_legacy.lan_transport import LanTransportError, _validate_lan_response
...
#
# These mock the aiohttp module reference INSIDE divoom_legacy.lan_transport so no
...
import divoom_legacy.lan_transport as lan_mod
