...
from divoom_legacy.utils.divoom_image_encode_32 import encode_animation_frame_32 as py_encode_frame_32, pre_frames as py_pre_frames
from divoom_legacy.display.animation_8b import build_8b_phases as py_build_8b
