...
sys.modules["divoom_legacy.media_decoder"] and leaks it for the rest of the
...
sys.modules.pop("divoom_legacy.media_decoder", None)
media_decoder = importlib.import_module("divoom_legacy.media_decoder")
import divoom_legacy
divoom_legacy.media_decoder = media_decoder
...
def reload_with_fake_library_path():
    """Reload divoom_legacy.media_decoder with native_lib.library_path patched,
    ...
    replaced sys.modules["divoom_legacy.media_decoder"] with a DIFFERENT module
    ...
    def _apply(fake_path):
        sys.modules["divoom_legacy.media_decoder"] = media_decoder
