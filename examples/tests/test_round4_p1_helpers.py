...
Covers:
  - divoom_legacy.system.control.Control   (set_keyboard, set_hot, set_light_mode)
  - divoom_legacy.system.sound.SoundControl (set_sound_control, set_auto_power_off, etc.)
  - divoom_legacy.display.design.Design    (set_eq, set_language, user-define time)
...
from divoom_legacy.game import Game, GAME_ID_DINO, GAME_ID_2048, GAME_ID_MAGIC_BALL
...
def fake_divoom(mock_client):
    ...
    with patch("divoom_legacy.divoom.BleakClient", return_value=mock_client):
        d = Divoom(
