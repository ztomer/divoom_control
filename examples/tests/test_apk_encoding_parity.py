...
import numpy as np
from divoom_legacy.utils.divoom_image_encode import encode_animation_frame
from divoom_legacy.utils.divoom_image_encode_32 import encode_animation_frame_32
from divoom_legacy.display.animation_8b import _phase_start, _phase_data, _phase_terminate, CONTROL_START_SENDING, CONTROL_SENDING_DATA, CONTROL_TERMINATE_SENDING, SENDING_DATA_CHUNK_SIZE
